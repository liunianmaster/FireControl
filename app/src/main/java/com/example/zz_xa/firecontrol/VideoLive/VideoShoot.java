...
/**
 * Created by Adminstrator of wxb on 2018/5/11.
 * Fix by:
 */

public class VideoShoot extends Activity implements SurfaceHolder.Callback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View view) {
                ...
                if (!mStartedFlg) {
                  ...
                  //  mSurfaceview.setVisibility(View.GONE);
                    ...
                    if (camera != null) {
                        camera.setDisplayOrientation(90); //开始录制前，预览角度
                        camera.unlock();
        ...
        mBtnPlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mediaPlayer = MediaPlayer.create(VideoShoot.this, uri);
