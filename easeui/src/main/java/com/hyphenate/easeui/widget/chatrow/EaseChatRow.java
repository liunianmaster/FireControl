...
public abstract class EaseChatRow extends LinearLayout {
    ...
    private void initView() {
        ...
        //userAvatarView.setBackground(getResources().getDrawable(R.drawable.ease_de));
        userAvatarView.setImageDrawable(getResources().getDrawable(R.drawable.ease_chat_item_file));
